(() => {
  ...
  function generateResizedSvg(svgEl, targetWidthPx, targetHeightPx, unit, options = {}) {
    ...
    const leftMargin = includeDimensions
      ? Math.max(marginBase, dimOffset + tickSize + labelHalfSize)
      : marginBase;
    ...
    const dimensionContentBottom = includeDimensions
      ? horizontalLabelY + labelHalfSize
