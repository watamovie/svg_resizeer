(() => {
  ...
  function generateResizedSvg(svgEl, targetWidthPx, targetHeightPx, unit, options = {}) {
    ...
    const extensionDashArray = `${formatNumber(strokeWidth * 2)} ${formatNumber(
      strokeWidth * 1.5
    )}`;
    ...
    const dimensionLines = includeDimensions
      ...
      <g data-generated-by="dimension-overlay" fill="none" stroke="${dimensionColors.stroke}" stroke-width="${strokeWidth}" stroke-linecap="round">
        ...
        <line x1="${viewBox.minX}" y1="${viewBox.minY}" x2="${viewBox.minX}" y2="${horizontalY}" stroke-dasharray="${extensionDashArray}"></line>
        <line x1="${viewBox.minX + viewBox.width}" y1="${viewBox.minY}" x2="${viewBox.minX + viewBox.width}" y2="${horizontalY}" stroke-dasharray="${extensionDashArray}"></line>
        <line x1="${verticalX}" y1="${viewBox.minY}" x2="${viewBox.minX}" y2="${viewBox.minY}" stroke-dasharray="${extensionDashArray}"></line>
        <line x1="${verticalX}" y1="${viewBox.minY + viewBox.height}" x2="${viewBox.minX}" y2="${viewBox.minY + viewBox.height}" stroke-dasharray="${extensionDashArray}"></line>
